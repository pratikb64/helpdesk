    ...
    create_custom_fields(
        {
            ...
            **get_custom_fields_for_canned_responses(),
        }
    )
    add_default_status()
...
def get_custom_fields_for_assignment_rule():
...
def get_custom_fields_for_canned_responses():
    """Helpdesk specific custom fields that needs to be added to the Email Template DocType."""
    return {
        "Email Template": [
            {
