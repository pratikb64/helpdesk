<template>
  ...
  <div v-if="!slaData.loading" class="bg-white px-10 pt-8 pb-6">
...
import SlaAssignmentConditions from "../../../pages/settings/Sla/components/SlaAssignmentConditions.vue";
import SlaHolidays from "../../../pages/settings/Sla/components/SlaHolidays.vue";
import SlaPriorityList from "../../../pages/settings/Sla/components/SlaPriorityList.vue";
import SlaStatusList from "../../../pages/settings/Sla/components/SlaStatusList.vue";
