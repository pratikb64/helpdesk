<template>
  ...
  <div class="max-w-3xl xl:max-w-4xl mx-auto w-full p-4 lg:py-8">
    <SettingsLayoutHeader
      :description="
        __('Sent to all of the recipients associated with an agent\'s reply')
      "
    >
      <template #title>
    ...
    <div class="flex gap-x-1 items-start justify-between mt-6">
      <p class="text-sm text-gray-700 leading-5">
        ...
        <a
          href="https://docs.frappe.io/helpdesk/email-notifications#available-variables-reply-from-agent"
          target="_blank"
